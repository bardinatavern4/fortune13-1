...
/datum/job/ncr/f13firstsergeant
	...
	total_positions = 0 //this basically doesn't get used, if someone reworks it later maybe it'll be brought back. Don't delete it.
	spawn_positions = 0
...
/datum/job/ncr/f13ncroffduty
	title = "NCR Off-Duty"
	flag = F13NCROFFDUTY
	total_positions = 0 //An off duty rear-echelon role was created to reduce role bloat, this isn't a necssary job.
	spawn_positions = 0
